...
<div id="container">
	<div id="header">
		User Task Form: blogPostProcess.findabusivewords
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">emailValidationResult</label>
                            		<div class="div_checkbox">
                              		${emailValidationResult}
                            		</div>
                            		<label for="name">contentValidationResult</label>
                            		<div class="div_checkbox">
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="Result" type="text" class="textbox" id="Result" value="${Result}" />
                            		</div>
